import re
import requests
from chatbot_py.keys import TRELLO_API_KEY, TRELLO_TOKEN
from chatbot_py.long_responses import unknown
...
responses = [
    ...
    {
        "text": "I'm T-Bot, your ticket chatbot! What can I help you with?",
